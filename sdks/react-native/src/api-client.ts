// ---------------------------------------------------------------------------
// CIP KYC React Native SDK — API Client
// ---------------------------------------------------------------------------
...
export class ApiClient {
   ...
   * In React Native, imageUri is a local file URI (file://...).
   */
  async processFrame(
    sessionId: string,
    step: string,
    ...
    return this.request<StepResult>(
      'POST',
   ...
   * Each frame is a local file URI.
   */
  ...
  private async request<T>(
    ...
    if (body) {
      init.body = body;
      // Do NOT set Content-Type for FormData — RN sets boundary automatically
    }
