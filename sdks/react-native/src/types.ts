// ---------------------------------------------------------------------------
// CIP KYC React Native SDK — Type Definitions
// ---------------------------------------------------------------------------

export interface CipKycProps {
...
export const DEFAULT_STRINGS: Record<string, string> = {
  ...
  'liveness.intro': "We'll check you're a real person",
  'liveness.blink': 'Blink your eyes naturally',
  'liveness.turn': 'Slowly turn your head to the left',
