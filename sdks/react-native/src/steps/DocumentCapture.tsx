// ---------------------------------------------------------------------------
// CIP KYC React Native SDK — Document Capture Step
// ---------------------------------------------------------------------------
...
export function DocumentCapture({
  ...
  const handleConfirm = useCallback(async () => {
    ...
    try {
      const result = await apiClient.processFrame(sessionId, stepName, capturedUri);
  ...
  }, [capturedUri, apiClient, sessionId, stepName, onError]);
